...
namespace Virtuesoft.Framework.Gateaway
{
    ...
    public class GateawayOption
    {
        ...
        /// 验证必要参数
        /// </summary>
        public virtual (bool status, string message) VerifyPrameters(IDictionary<string, string> forms, HttpContext httpContext) {
            return OnVerifyPrameters(forms, httpContext);
        }
        /// <summary>
        /// 验证必要参数
        /// </summary>
        ...
        /// 访问开始
        /// </summary>
        public virtual Task BeginRequest(Operation operation, HttpContext httpContext) {
            return OnBeginRequest(operation, httpContext);
        }
        /// <summary>
        /// 访问开始
        /// </summary>
        public Func<Operation, HttpContext, Task> OnBeginRequest = (operation, httpContext) => { return Task.CompletedTask; };
        /// <summary>
        /// 访问结束
        /// </summary>
        public virtual Task EndReqeust(Operation operation, HttpContext httpContext)
        {
            return OnEndReqeust(operation, httpContext);
        }
        /// <summary>
        /// 访问结束
        /// </summary>
        public Func<Operation, HttpContext, Task> OnEndReqeust = (operation, httpContext) => { return Task.CompletedTask; };
        /// <summary>
        /// 验证ip地址是否允许访问接口
        /// </summary>
